#ifndef TRANSLATION_DELTA_COST_FUNCTOR_2D_H
#define TRANSLATION_DELTA_COST_FUNCTOR_2D_H
...
private:
  ...
  explicit TranslationDeltaCostFunctor2D(
    ...
    , x_(target_translation(0))
    , y_(target_translation(1))
  {
  }
...
#endif /* TRANSLATION_DELTA_COST_FUNCTOR_2D_H */
